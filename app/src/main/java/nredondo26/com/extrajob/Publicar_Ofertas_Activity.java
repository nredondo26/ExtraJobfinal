...
public class Publicar_Ofertas_Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /* <editremuneracion>.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                Log.e("formateado ",formatear(Double.parseDouble(editremuneracion.getText().toString()))) ;
            }
        });*/
        ...
        bregistrar_oferta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               /* if(editcategoria.getText().equals("Seleccione Categoria")){
                   ...
                   Log.e("formateado ",formatear(editremuneracion.getText().toString())) ;
                   // createAccount();
                }*/
            }
        });
